...
RNode getZmassV2::run(RNode d) {
  ...
  auto d1 = d.Define("Mu1_eta", "Muon_eta[0]")
    ...
    .Define("Mu1_charge", "Muon_charge[0]")
    .Define("Mu1_relIso", "Muon_pfRelIso04_all[0]")
    .Define("Mu1_pt", "Muon_corrected_pt[0]")
    .Define("Mu1_hasTriggerMatch", "Muon_hasTriggerMatch[0]")
    .Define("Mu2_eta", "Muon_eta[1]")
    .Define("Mu2_phi", "Muon_phi[1]")
    .Define("Mu2_charge", "Muon_charge[1]")
    .Define("Mu2_relIso", "Muon_pfRelIso04_all[1]")
    .Define("Mu2_pt", "Muon_corrected_pt[1]")
    .Define("Mu2_hasTriggerMatch", "Muon_hasTriggerMatch[1]")
