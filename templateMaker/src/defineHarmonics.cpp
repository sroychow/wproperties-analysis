...
RNode defineHarmonics::run(RNode d)
{
  ...
  //define harmonics weights as variations
  std::vector<std::string> harmonicsVars = {"","P0", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "PUL"};
  defineHarmonics::vary("harmonicsVec", true, harmonicsVars);
