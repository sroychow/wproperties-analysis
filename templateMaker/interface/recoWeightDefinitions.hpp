#ifndef RECOWEIGHTDEFINITIONS_H
#define RECOWEIGHTDEFINITIONS_H

#include "module.hpp"

class recoWeightDefinitions : public Module
{
...
public:
    recoWeightDefinitions(TFile *SF)
    {
        _SF = SF;
